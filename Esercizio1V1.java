...
public class Esercizio1 {
    public static void main(String[] args){
        ...
        for(int i = 0; i < K; i++){
            ...
            dict.insert(chiave, valore);
        }

        System.out.println("Numero nodi: " + K);
        dict.stampa();
        binarySearchTree root = dict.getRooTree();
        //dict.stampa();
        root.dfsIn(root, 0);
...
class dizionario {
    ...
    public static binarySearchTree getRooTree(){
        return binarySearchTree.getRoot(tree);
    }
}
...
class binarySearchTree {
     ...
     * alterato
     */
    public static binarySearchTree insertChild(binarySearchTree tree, int key, char info){
     ...
     */
    public void dfsIn(binarySearchTree tree, int altezza){
        if(tree != null){
            int dx = -1;
            int sx = -1;
            if(tree.rightChild!= null){
                dx = tree.rightChild.key;
            }

            if(tree.leftChild!= null){
                sx = tree.leftChild.key;
            }
            System.out.println("Nodo: " + tree.key + " - dx: " + dx + " - sx: " + sx + " - altezza: " + altezza);
            //System.out.println("Nodo: "+tree.key+" Info: "+tree.info + " Altezza: " + altezza);
            dfsIn(tree.leftChild, altezza+1);
            dfsIn(tree.rightChild, altezza+1);
        }
    }
    ...
    public static binarySearchTree getRoot(binarySearchTree tree){
        if(tree.parent != null){
